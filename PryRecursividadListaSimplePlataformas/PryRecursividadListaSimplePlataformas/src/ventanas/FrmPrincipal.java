...
{
    ListaSimpleCaracteres plataformas;
    ...
    public FrmPrincipal()
    {
        ...
        plataformas = new ListaSimpleCaracteres();
        
        plataformas.adicionar("Netflix");
        plataformas.adicionar("Amazon");
        plataformas.adicionar("HBO max");
        plataformas.adicionar("Disney+");
        plataformas.adicionar("Fox+");
    }
    ...
    private void btnContarRecursivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContarRecursivoActionPerformed
        // TODO add your handling code here:
        int c;
        c = plataformas.contar(plataformas.inicio);
