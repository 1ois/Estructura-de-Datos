...
public class FrmPrincipal extends javax.swing.JFrame
{
    ...
    private void btnBuscarSecuencialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarSecuencialActionPerformed
        ...
        if(pos !=-1)
            JOptionPane.showMessageDialog(this,"Esata en la posicion "+pos);
        else
            JOptionPane.showMessageDialog(this,"Canal no esta en el vector");
                  
        
       JOptionPane.showMessageDialog(this,"Nro de comparaciones"+ vectorDeCanales.getContaEfi()); 
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if(pos !=-1){
            ...
            JOptionPane.showMessageDialog(this,"Cana modificado");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(pos !=-1){
            vectorDeCanales.eliminar(pos);
             JOptionPane.showMessageDialog(this,"Ya se hizo la eliminizacio "+pos);
        }
